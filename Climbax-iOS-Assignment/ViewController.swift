...
//        // Optionally refresh the favorite list view controller if it's visible
//        if let favoriteListVC = navigationController?.viewControllers.first(where: { $0 is FavoriteListViewController }) as? FavoriteListViewController {
//            favoriteListVC.reloadData()
//        }
//    }
}
